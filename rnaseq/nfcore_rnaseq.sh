...
Print_help() {
    ...
    echo "  -a/--more_args   <str>      Additional arguments to pass to 'nextflow run'"
    ...
    echo "  -n/--nf_file <file>   Main .nf workflow definition file                         [default: 'workflows/nfcore-rnaseq/workflow/main.nf']"
...
${e}Time nextflow run \
    ...
    -ansi-log false \
    -profile "$profile" \
    $config_arg $resume_arg $more_args
