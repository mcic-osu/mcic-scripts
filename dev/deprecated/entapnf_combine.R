...
message()
message("======================================================================")
message("Nr of input genes in annotation file 1:                     ", nrow(annot1))
message("Nr of input genes in annotation file 2:                     ", nrow(annot2))
message()
message("Total nr of output genes:                                   ", n_tot)
